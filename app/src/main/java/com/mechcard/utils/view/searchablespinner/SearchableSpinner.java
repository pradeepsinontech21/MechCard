package com.mechcard.utils.view.searchablespinner;
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        ...
        if (!_isFromInit) {
            ...
            if (!TextUtils.isEmpty(_strHintText) && !_isDirty) {
                ArrayAdapter arrayAdapter = new ArrayAdapter(_context, com.mechcard.R.layout
                        .layout_country_spinner, new String[]{_strHintText});
